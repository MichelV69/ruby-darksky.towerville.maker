...
@WIP
  Scenario Outline: Determine Building Profile for the "f22_to_middle" section of Towerville
    ...
    And the "f22_to_middle" section should be higher than 22 floors, but less than the "middle_to_crown" section
...
@WIP
  Scenario Outline: Determine Building Profile for the "middle_to_crown" section of Towerville
    ...
    And should be higher than the "f22_to_middle" section but less than the "crown" section
